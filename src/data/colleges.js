...
export const COLLEGES = [
  /* ------------------------------- Baghdad ------------------------------ */
  {
    ...
    programmes: {
      ...
      'english-language-literature': {
        college: 'College of Arts, Department of English',
        years: 4,
        language: 'English',
        minScore: 82.4,
        acceptanceRate: 28,
  ...
  /* -------------------------------- North ------------------------------- */
  {
    ...
    programmes: {
      ...
      'english-language-literature': {
        college: 'College of Languages, Department of English',
        years: 4,
        language: 'English',
        minScore: 78.9,
        acceptanceRate: 34,
  ...
  },
  {
    ...
    programmes: {
      ...
      'english-language-literature': {
        college: 'College of Humanities, Department of English',
        years: 4,
        language: 'English',
        minScore: 76.8,
        acceptanceRate: 39,
  ...
  },
  {
    ...
    programmes: {
      'english-language-literature': {
        college: 'College of Basic Education, Department of English',
        years: 4,
        language: 'English',
        minScore: 72.5,
        acceptanceRate: 49,
  ...
  },
  {
    ...
    programmes: {
      ...
      'english-language-literature': {
        college: 'College of Education, Department of English',
        years: 4,
        language: 'English',
        minScore: 75.1,
        acceptanceRate: 42,
  ...
  },
  {
    ...
    programmes: {
      'english-language-literature': {
        college: 'College of Education for Humanities, Department of English',
        years: 4,
        language: 'English',
        minScore: 76.0,
        acceptanceRate: 40,
  ...
  /* -------------------------------- South ------------------------------- */
  {
    ...
    programmes: {
      ...
      'english-language-literature': {
        college: 'College of Education for Human Sciences, Department of English',
        years: 4,
        language: 'English',
        minScore: 78.1,
        acceptanceRate: 35,
