 ...
 */
export default function MajoraMark({ className, strokeWidth = 9 }) {
  return (
    <svg
      className={className}
      viewBox="0 0 200 200"
    ...
    >
      ...
      <path d="M30.25 106.5V70Q30.25 65 34.5 62L100.5 16Q104.5 13 108.5 16L174.5 62Q178.65 65 178.65 70V157Q178.65 162.15 173.5 162.15H48" />
      ...
      <path d="M64.6 111V146Q90 153 104.5 177" />
      <path d="M145.6 111V146Q119 153 104.5 177" />
      ...
      <ellipse cx="30.2" cy="118.2" rx="7.2" ry="5.6" fill="currentColor" stroke="none" />
      <path d="M26 125 22.9 149M30.2 125V154M34.4 125 37.4 149" />
    </svg>
  )
}
