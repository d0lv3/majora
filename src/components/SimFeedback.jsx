...
/**
 * What the reader made of the simulation, asked at the end of it.
 *
  ...
  return (
    <aside className="simRate">
      <form onSubmit={submit}>
        ...
        <h2 className="simRate__title">What did you make of it?</h2>

        {/* The number is one answer and the writing is the other, and neither
            is the price of the other. The scale used to be compulsory — the
            Send button stayed dead until a number was picked — so a student
            with something to say and no opinion on a five-point line could not
            say it. Either one is enough now. */}
